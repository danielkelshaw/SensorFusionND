...
int main(int argc, const char *argv[])
{
    ...
    // vector<std::string> detectorTypeList   = {"SHITOMASI"};  
    vector<std::string> descriptorTypeList = {"BRISK", "BRIEF", "ORB", "FREAK", "AKAZE", "SIFT"};                        
    // vector<std::string> descriptorTypeList = {"BRISK"};                        
    ...
    for (auto& combo : combinations)
    {
        ...
        for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
        {
            ...
            cout << "#3 : EXTRACT DESCRIPTORS" << endl;
            ...
            if (dataBuffer.size() > 1) // wait until at least two images have been processed
            {
                ...
                cout << "#4 : MATCH KEYPOINT DESCRIPTORS" << endl;
